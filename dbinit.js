...
async function dbinit(){
    ...
    await db.run("INSERT INTO Courses VALUES (?,?,?,?,?,?,?)",['3DM3','Discrete Mathematics', '3.0','1','Online','SFWRTECH Lv3','Fundamental discrete mathematics concepts relevant to IT: sets, relations, functions, graphs, propositional logic. State machines. Input/output specifications. Invariants.']);
